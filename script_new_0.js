    ...
    function renderJobCard(job) {
      ...
      if (status === 'ready') {
        ...
        timerPrefix = 'Prod: ';
        actionBtnHtml = '<button class="btn-action-main state-active" onclick="openMetricsModal(' + job.id + ','' + job.job_title + '',' + unitsActual + ',' + wasteTotal + ',' + stopsTotal + ')">📊 ' + (isTR ? 'Veri Gir' : 'Enter Metrics') + '</button>';
